...
SELECT	city, COUNT(customer_id) as num_of_customer
FROM	sale.customer
GROUP BY
		city
ORDER BY
		2 DESC -- num_of_customer DESC
...
SELECT	order_id, SUM(quantity) num_of_product
